...
static void node_shader_update_sdf_op(bNodeTree *ntree, bNode *node)
{
  ...
  /* Distance */
  blender::bke::node_set_socket_availability(*ntree, *sockInputA, true);

  blender::bke::node_set_socket_availability(*ntree, *sockInputB,
                            !ELEM(sdf->operation,
                                  SHD_SDF_OP_MASK,
                                  SHD_SDF_OP_INVERT,
                                  SHD_SDF_OP_DILATE,
  ...
  blender::bke::node_set_socket_availability(*ntree, *sockCount, ELEM(sdf->operation, SHD_SDF_OP_ONION));
