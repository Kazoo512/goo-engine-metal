...
#  define drw_view_goo drw_view_[drw_view_id]
#  define drw_view_culling_goo drw_view_culling_[drw_view_id]
#  define DRW_VIEW_LEN DRW_VIEW_MAX
#  define ModelMatrixGoo drw_ModelMatrix
#  define ModelMatrixInverseGoo drw_ModelMatrixInverse
#endif
...
GPU_SHADER_CREATE_INFO(draw_resource_id_goo)
...
GPU_SHADER_CREATE_INFO(draw_modelmat_goo)
UNIFORM_BUF_FREQ(DRW_OBJ_MAT_UBO_SLOT, ObjectMatrices, drw_matrices[DRW_RESOURCE_CHUNK_LEN], BATCH)
DEFINE_VALUE("ModelMatrixGoo", "(drw_matrices[resource_id].model)")
DEFINE_VALUE("ModelMatrixInverseGoo", "(drw_matrices[resource_id].model_inverse)")
...
DEFINE("DRW_LEGACY_MODEL_MATRIX")
PUSH_CONSTANT(MAT4, ModelMatrixGoo)
PUSH_CONSTANT(MAT4, ModelMatrixInverseGoo)
ADDITIONAL_INFO(draw_view_goo)
GPU_SHADER_CREATE_END()
...
GPU_SHADER_CREATE_INFO(draw_view_goo)
UNIFORM_BUF_FREQ(DRW_VIEW_UBO_SLOT, ViewMatrices, drw_view_[DRW_VIEW_LEN], PASS)
DEFINE("DRAW_VIEW_CREATE_INFO")
DEFINE_VALUE("drw_view_goo", "drw_view_[drw_view_id]")
TYPEDEF_SOURCE("draw_shader_shared.hh")
GPU_SHADER_CREATE_END()
