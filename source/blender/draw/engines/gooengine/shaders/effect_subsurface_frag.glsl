...
void main(void)
{
  ...
  float homcoord = ProjectionMatrixGoo[2][3] * depth_view + ProjectionMatrixGoo[3][3];
  vec2 scale = vec2(ProjectionMatrixGoo[0][0], ProjectionMatrixGoo[1][1]) * sss_radius / homcoord;
