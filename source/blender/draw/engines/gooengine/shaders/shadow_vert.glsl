...
void main()
{
  ...
  vec3 pos, binor;
  hair_get_pos_tan_binor_time((ProjectionMatrixGoo[3][3] == 0.0),
...
#    endif
  pass_attr(pos, NormalMatrix, ModelMatrixInverseGoo);
#  endif
#endif
}
...
vec3 attr_load_orco(samplerBuffer cd_buf)
{
  ...
  vec3 lP = transform_point(ModelMatrixInverseGoo, P);
