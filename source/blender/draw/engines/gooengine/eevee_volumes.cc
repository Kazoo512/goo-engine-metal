...
void EEVEE_volumes_cache_init(EEVEE_ViewLayerData *sldata, EEVEE_Data *vedata)
{
      ...
      !LOOK_DEV_STUDIO_LIGHT_ENABLED(draw_ctx->v3d))
  {
    ...
    if (grp) {
      ...
      grp = blender::draw::DRW_shgroup_volume_create_sub(nullptr, nullptr, grp, mat);
                                    ...
                                    const blender::draw::ObjectRef &ob_ref)
{
  ...
  grp = blender::draw::DRW_shgroup_volume_create_sub(scene, ob, grp, mat);
  ...
  DRW_shgroup_call_procedural_triangles(grp, ob_ref, sldata->common_data.vol_tex_size[2]);
