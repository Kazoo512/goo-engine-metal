...
void EEVEE_cryptomatte_cache_populate(EEVEE_Data *vedata, EEVEE_ViewLayerData *sldata, const blender::draw::ObjectRef &ob_ref);
...
void EEVEE_motion_blur_cache_populate(EEVEE_ViewLayerData *sldata, EEVEE_Data *vedata, const blender::draw::ObjectRef &ob_ref);
...
/** `eevee_engine.cc` */
void EEVEE_cache_populate(void *vedata, blender::draw::ObjectRef &ob_ref);
